...
denormal.add_source_files(ROOT / "float_arithmetic_operations/*.vhd")

denormal.add_source_files(ROOT / "normalizer/normalizer_configuration/normalizer_with_2_stage_pipe_pkg.vhd")
denormal.add_source_files(ROOT / "normalizer/*.vhd")

denormal.add_source_files(ROOT / "denormalizer/denormalizer_configuration/denormalizer_with_2_stage_pipe_pkg.vhd")
denormal.add_source_files(ROOT / "denormalizer/*.vhd")

denormal.add_source_files(ROOT / "float_to_real_conversions" / "*.vhd")

denormal.add_source_files(ROOT / "float_adder/*.vhd")

denormal.add_source_files(ROOT / "float_multiplier/*.vhd")

denormal.add_source_files(ROOT / "float_alu/*.vhd")

denormal.add_source_files(ROOT / "float_first_order_filter/*.vhd")
