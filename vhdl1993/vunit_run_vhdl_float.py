#!/usr/bin/env python3
"""VUnit runner for the legacy, non-generic package tree (superseded by
vhdl2008/ - see vunit_run_vhdl_float.py at the repo root for the active
suite). Kept building here so it doesn't bit-rot."""
